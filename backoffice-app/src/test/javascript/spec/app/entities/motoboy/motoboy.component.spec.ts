...
import { MotoboyComponent } from 'app/entities/motoboy/motoboy.component';
import { MotoboyService } from 'app/entities/motoboy/motoboy.service';
import { Motoboy } from 'app/shared/model/motoboy.model';

describe('Component Tests', () => {
  describe('Motoboy Management Component', () => {
    let comp: MotoboyComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MotoboyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.motoboys[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
